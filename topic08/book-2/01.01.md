...
5. When prompted, sign in using the **same GitHub account** that you used for student benefits(if you did this).
...
This lab covers the first three steps in that workflow. These commands are distributed as Markdown prompt files. In VS Code,  these prompt files can be invoked directly from AI chat as slash commands.

To install the required slash commands, go to the [liatrio-labs/spec-driven-workflow repo](https://github.com/liatrio-labs/spec-driven-workflow) and follow the instructions for your machine(i.e. windows powershell/mac)
...
- Clone [https://github.com/fxwalsh/skills-repo-up-to-movie-lab-4-full](https://github.com/fxwalsh/skills-repo-up-to-movie-lab-4-full ) onto your machine.
...
+ Commit the changes to the repo:
  ...
  ~~~cmd
  git add -a
  git commit "Added React skills folder as reference for SSD"
  ~~~
