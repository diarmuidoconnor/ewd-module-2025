...
~~~
The above handler returns a JWT token in the HTTP Set-Cookie response header for a successful login attempt. We use this token with subsequent requests as proof of authentication.
