...
We want to use our authentication infrastructure to protect functionality accessed through a separate API (the App API). Requests to this functionality must include a valid JWT token in the HTTP Cookies request header. 
