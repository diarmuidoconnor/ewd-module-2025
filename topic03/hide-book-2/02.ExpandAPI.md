...
'isValidMoviePayload' is a dynamically generated function to validate a JS object against the Movie schema produced by typescript-json-schema. Using cmd-k/cmd-i to check the type of the body variable before and after the if-statement. It changes from the 'any' type to Movie, i.e. the isValidMoviePayload has performed __type narrowing__. 
