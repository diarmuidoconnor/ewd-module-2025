...
export default (dependencies) => {
    ...
    const createContact = async (request, response, next) => {
        const { userName, name, password, type, dob, phone,email } = request.body;
        const contact = await contactsService.addContact(userName, name, password, type, dob, phone, email, dependencies);
