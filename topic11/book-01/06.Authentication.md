...
### ADD Authentication back into API

Lets undo the temporary removal of authentication we did earier

+ **IN YOUR EXPRESS APP** uncomment the code in the Movies router that does JWT authentication. Open /src/movies/routes/index.js and comment out the lines indicated below. 

 <img src="./img/image-20230420095356736.png" alt="image-20230420095356736" style="zoom:50%;" />
