...
+ Copy only the `skills` folder from the skills repo you cloned in the previous step and paste it into the root of the Movies-App-Lab-3 solution. The AI will use this as a reference.
...
- Copy the following into your AI chat:
...
It will take some time to generate the specs/lab4-caching-context-reviews/spec.md file. Examine this file and check that it is accurate. You can edit it if you notice any errors or omissions.
