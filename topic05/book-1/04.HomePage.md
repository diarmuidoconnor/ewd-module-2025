...
~~~
Also, create the file `src/components/MovieList.tsx` (referenced by the above code) and add this code:
~~~tsx
import Movie from "./MovieCard";
import Grid from "@mui/material/Grid";
import { BaseMovieListProps } from "../types/movieApp";
...
We will use sample data from a file `src/data/sampleData.ts`. Create the file and add the following:
...
~~~
The App component is at the top of the component hierarchy - this will change in a future lab. To see the HomePage rendering start the development server provided by the Vite tool:
~~~
npm run dev
~~~
