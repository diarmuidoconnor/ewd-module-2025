...
+ Add the MovieListPageTemplateProps  in src/types/moviesApp.ts as follows :
...
Create the file `src/components/TemplateMovieListPage.tsx` and add the following code:
...
import {MovieListPageTemplateProps} from "../types/movieApp";
