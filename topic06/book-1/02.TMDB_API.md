...
import { MovieDetailsProps , MovieImage} from "../types/movieAppType";// replace existing MoviePageProps import
...
Create a new type to restrict the Filter options to either `"title"` or `"genre"`. In `src/types/movieAppType.ts`, add the following type:
