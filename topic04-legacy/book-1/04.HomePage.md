...
const MovieList: React.FC<{movies: BaseMovie[]}> = (props) => {
...
We will eventually plug this page into a routing component. In the meantime, we will statically link it to a top-level component that feeds it an array of movies. Create `src/main.tsx` and add this code:
~~~
import React from "react";
