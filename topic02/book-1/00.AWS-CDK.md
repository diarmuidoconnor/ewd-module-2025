...
The CDKToolkit stack creates some resources, for example, an S3 bucket that store assets required by the CDK framework. __NEVER DELETE__ any resources created by the bootstrapping process.
